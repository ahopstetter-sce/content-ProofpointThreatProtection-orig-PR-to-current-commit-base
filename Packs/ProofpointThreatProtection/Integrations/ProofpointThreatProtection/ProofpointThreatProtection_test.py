...
TEST_SERVER_BASE_URL = 'http://{}:{}/api/v1'.format(TEST_SERVER_IP_BINDING, TEST_SERVER_TCP_PORT)
TEST_AUTH_HOST = 'http://{}:{}/v1'.format(TEST_SERVER_IP_BINDING, TEST_SERVER_TCP_PORT)
